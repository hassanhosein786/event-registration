...
import { BarChart3, FileText, LayoutDashboard, LogOut, Settings, Shield, Menu, Archive } from "lucide-react";
...
const AdminLayout = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 lg:flex">
      <aside className={`border-r border-white/10 bg-slate-950/90 transition-all duration-300 ${collapsed ? "lg:w-20" : "lg:w-72"}`}>
