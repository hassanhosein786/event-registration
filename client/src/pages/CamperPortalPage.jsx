...
const Detail = ({ label, value }) => (
  <div className="rounded-2xl border border-white/10 bg-white/5 p-2 sm:p-3">
    <div className="text-[9px] uppercase tracking-[0.16em] text-slate-500 sm:text-[11px]">{label}</div>
    <div className="mt-1 break-words text-xs leading-snug text-slate-200 sm:text-sm">{value}</div>
  </div>
);
