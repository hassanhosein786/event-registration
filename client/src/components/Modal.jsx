...
const Modal = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-stretch justify-center bg-slate-950/80 px-0 py-0 sm:items-center sm:px-4 sm:py-6">
      <div className="flex h-[100dvh] w-full flex-col overflow-hidden rounded-none border-0 border-white/10 bg-slate-950 shadow-glow sm:h-auto sm:max-h-[85vh] sm:max-w-lg sm:rounded-3xl sm:border">
