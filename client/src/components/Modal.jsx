  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto bg-slate-950/80 px-0 py-0 sm:px-4 sm:py-6">
      <div className="min-h-full w-full sm:flex sm:items-center sm:justify-center">
        <div className="flex w-full max-h-[calc(100dvh-1rem)] flex-col rounded-none border-0 border-white/10 bg-slate-950 shadow-glow sm:max-h-[85vh] sm:max-w-lg sm:rounded-3xl sm:border">
          ...
          <div className="border-t border-white/10 px-4 py-3 pb-[calc(env(safe-area-inset-bottom)+0.5rem)] sm:px-6 sm:py-4 sm:pb-4">
